...
#set window color
root['background']= '#FFB7A7'       #This is Hexa color code 
root.title("movie") 
l=Label(root, text = "Welcome to the Movie app")
l.place(x=10,y=70)
l.pack()
text = Label(root, text="Plese,Enter your requirements for movie ticket booking")
...
l.place(x=10,y=70)
l.pack()
text = Label(root, text="Your Movie is succesfully booked ")
text.place(x=70,y=90)
...
c=Label(root, text = "Enjoy the movie")
c.place(x=70,y=150)
# c.pack()
root.mainloop()
c=Label(root, text = "Enjoy the movie")
